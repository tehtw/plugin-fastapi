...
@Getter
@NoArgsConstructor
public abstract class AbstractFastApi extends Task  {
    @NotNull
    @NotEmpty
    @Schema(
        title = "FastApi domain.",
    ...
    private String baseUri(RunContext runContext) throws IllegalVariableEvaluationException {
        return runContext.render(this.domain);
    }
    ...
    private String token(RunContext runContext) throws IllegalVariableEvaluationException, MalformedURLException, URISyntaxException {
        ...
        MutableHttpRequest<String> request = HttpRequest.create(HttpMethod.POST, "/auth/login")
